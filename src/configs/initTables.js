...
const SQLSTATEMENT = ` 
    ...
    -- insert sample data (passwords for the user accs are exactly the same as the username)
    ...
    ('user3', 'user3@gmail.com', '$2a$10$sX0dHMEHL3WjRpc5rQxDnedgXpFxP7IkR/tJ4Do/HKb82r.BVNgIu', 10.20);
